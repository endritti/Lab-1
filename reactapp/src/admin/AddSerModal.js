...
export class AddSerModal extends Component{
    constructor(props){
        super(props);
                        ...
                        <Row>
                            <Col sm={6}>
                                ...
                                <Form.Group controlId="name">
                                    ...
                                    <Form.Control type="text" name="name" required placeholder="serieName"/>
                                </Form.Group>
                                <Form.Group controlId="description">
                                    <Form.Label>Serie Description</Form.Label>
                                    <Form.Control type="text" name="description" required placeholder="serieDescription"/>
                                </Form.Group>
